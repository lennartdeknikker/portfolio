<template>
  <div class="logo-container">
    ...
    <svg
      ...
      xml:space="preserve"
    >
      <transition-group tag="g" name="draw-logo-1">
        <path
          key="1"
          v-if="drawLogo"
          stroke="#2AA198"
          fill="transparent"
          class="red"
          d="M203.2,99.1c-4.3,3.8-8.5,7.5-12.7,11.3c0.8,1,1.5,1.9,2.2,2.8c2.9,3.8,5.5,7.8,7.3,12.2
        ...
        <path
          ...
          fill="transparent"
          class="black"
          d="M32.2,212.8c1.4,0.2,2.6,0.4,3.7,1.2c12.5,9.8,23.8,20.9,34.2,32.9c4.6,5.3,9,10.8,13.5,16.2
        ...
        <path
          ...
          fill="transparent"
          class="blue"
          d="M115.5,214.6c0.9-2,1.7-3.9,2.5-5.8c0.6-1.2,1.4-2.2,2.7-2.6c1.9-0.7,3.6-0.2,5,1.1c2.4,2.4,4.7,4.9,7.1,7.4
        ...
        <path
          ...
          fill="transparent"
          class="green"
          d="M105.7,237c-1.5,0.4-2.6,0.5-3.8-0.7c-2.4-2.6-5-5-7.5-7.4c-0.3-0.3-0.7-0.6-0.2-1.1c0.5-0.4,0.7-1.3,1.6-0.7
        ...
        <path
          ...
          fill="transparent"
          class="purple"
          d="M88.1,247c2-1.1,3.9-2.1,5.6-3.3c0.7-0.5,1-1.5,1.5-2.3c0.2-0.3,0.5-0.8,0.6-0.8c0.6,0.1,1.1,0.3,1.7,0.6
...
.draw-logo-1-enter-active {
  ...
  stroke-dashoffset: 0;
  animation: dash-red 1.5s linear 1;
}
@keyframes dash-red {
  from {
